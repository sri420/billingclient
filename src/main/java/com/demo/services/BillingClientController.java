...
public class BillingClientController {
	...
	public String getMessage(@PathVariable String id,@PathVariable String id2){
		ResponseEntity<String> response=loadBalancedRestTemplate.exchange("http://billing/api/billing/message/{id}/{id2}",HttpMethod.GET,null,String.class,id,id2);
	...
	public String getMessage_Using_LoadBalancerClient_RibbonAPI(@PathVariable String id,@PathVariable String id2){
		...
		ServiceInstance instance = loadBalancer.choose("billing");
	...
	public String getMessageWithNon_LoadBalancedRestTemplate(@PathVariable String id,@PathVariable String id2){
		RestTemplate restTemplate =new RestTemplate();
		ResponseEntity<String> response=restTemplate.exchange("http://localhost:1010/api/billing/message/{id}/{id2}",HttpMethod.GET,null,String.class,id,id2);
		return response.getBody().toString();
	}
